package com.indikaudaya.best_farmer_admin.ui.buyer;
...
public class BuyerFragment extends Fragment {
    ...
    private static final String TAG = BuyerFragment.class.getName();
    View root;
    EditText searchText;
    Button searchButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_buyer, container, false);
        initMethod();
            ...
            users.whereGreaterThanOrEqualTo("email", String.valueOf(searchText.getText()))
                    ...
                    .get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            ...
                            ArrayList<BuyerAdapterModel> models = new ArrayList<>();

                            for (DocumentSnapshot ds : documents) {
                                Map<String, Object> data = ds.getData();
                                if (data.get("shopName") == null) {
                                    models.add(new BuyerAdapterModel(
    ...
    private void initCartRecycler(ArrayList<BuyerAdapterModel> models) {
        RecyclerView recyclerView = root.findViewById(R.id.recyclerView);
        BuyerAdapter cartAdapter = new BuyerAdapter(models);
